ServerEvents.recipes(event => {
    event.recipes.modern_industrialization.chemical_reactor(8, 200)
        ...
        .itemOut("1x #c:dusts/calcium_sulfate")
    ...
    event.recipes.modern_industrialization.chemical_reactor(128, 100)
        ...
        .fluidIn("modern_industrialization:oxygen", 4000)
        .itemIn("1x roll_mod:2_circuit", 0.0)
        .itemIn("16x #c:plates/platinum", 0.0)
        .fluidOut("modern_industrialization:nitric_acid", 1000)
        .fluidOut("minecraft:water", 1000)

    event.recipes.modern_industrialization.chemical_reactor(32, 400)
        .itemIn("16x #c:plates/platinum", 0.0)
        .itemIn("16x #c:dusts/iron")
    ...
    event.recipes.modern_industrialization.chemical_reactor(16, 200)
        .itemIn("32x #c:netherrack")
        .itemIn("8x #c:dusts/diamond")
        .itemIn("1x #c:dusts/iridium")
    ...
    event.recipes.modern_industrialization.chemical_reactor(64, 600)
        .itemIn("4x #c:wires/tungsten", 0.0)
    ...
    event.recipes.modern_industrialization.chemical_reactor(32, 100)
        .fluidIn("3000x modern_industrialization:carbon_dioxide")
        .fluidIn("6000x modern_industrialization:sodium_hydroxide")
        .itemOut("6x roll_mod:sodium_carbonate")
        .fluidOut("3000x minecraft:water")

    event.recipes.modern_industrialization.chemical_reactor(32, 100)
        .itemIn("1x #c:ender_pearls")
        .fluidIn("extended_industrialization:blazing_essence", 40)
        .itemOut("1x #c:ender_eyes")
        .registeredCondition({
            "mi_tweaks:voltage": {
                "voltage": "mv"
            }
    ...
    event.recipes.modern_industrialization.chemical_reactor(256, 100)
        .itemIn("8x #c:ingots/uranium_238")
        .itemIn("1x #c:ingots/plutonium")
        .fluidIn("16000x modern_industrialization:liquid_air")
        .itemOut("4x #c:ingots/uranium_235")
        .fluidOut("4000x modern_industrialization:radon")

    event.recipes.modern_industrialization.chemical_reactor(256, 120)
        .itemIn("32x #c:dusts/thorium")
        .itemIn("4x #c:ingots/uranium_235")
        .fluidIn("16000x modern_industrialization:liquid_air")
        .itemOut("2x #c:dusts/plutonium")
        .fluidOut("4000x modern_industrialization:radon")

    event.recipes.modern_industrialization.chemical_reactor(64, 100)
        .itemIn("4x extendedae:entro_crystal")
        .itemIn("2x #c:plates/iridium")
    ...
    event.recipes.modern_industrialization.chemical_reactor(32, 600)
        ...
        .itemOut("1x #c:dusts/obsidian")

    event.recipes.modern_industrialization.chemical_reactor(32, 600)
        .itemIn("30x roll_mod:raw_crystal_chip_parts")
        .itemIn("16x #c:wires/ruthenium")
        .itemIn("4x #c:plates/gold")
        .fluidIn("1000x extended_industrialization:phosphoric_acid")
    ...
    event.recipes.modern_industrialization.chemical_reactor(32, 400)
        ...
        .itemOut("30x #c:dusts/calcium_sulfate")

...
event.recipes.modern_industrialization.chemical_reactor(128, 120)
.itemIn("16x roll_mod:mirror")
.itemIn("16x minecraft:prismarine_crystals")
.itemIn("16x ae2:ender_dust")
.fluidIn("5000x modern_industrialization:polyvinyl_chloride")
.fluidIn("1500x sophisticatedcore:xp_still")

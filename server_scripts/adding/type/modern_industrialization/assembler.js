ServerEvents.recipes(event => {
    const planeTypes = {
        'pzl37los': { plates: 8, circuits: 2, extraCount: 2, motor: 'modern_industrialization:large_motor', motorCount: 4 },
        'pzlp11': { plates: 6, circuits: 1, extraCount: 1, motor: 'modern_industrialization:motor', motorCount: 4 },
        'trimotor': { plates: 10, circuits: 2, extraCount: 3, motor: 'modern_industrialization:large_motor', motorCount: 6 },
        'vulcanair': { plates: 6, circuits: 1, extraCount: 1, motor: 'modern_industrialization:motor', motorCount: 4 },
        'e500': { plates: 8, circuits: 2, extraCount: 1, motor: 'modern_industrialization:large_motor', motorCount: 4 },
        'bell206': { plates: 6, circuits: 1, extraCount: 1, motor: 'modern_industrialization:motor', motorCount: 4 },
        'bell47g': { plates: 4, circuits: 1, extraCount: 1, motor: 'modern_industrialization:motor', motorCount: 2 },
        'comanche': { plates: 6, circuits: 2, extraCount: 1, motor: 'modern_industrialization:large_motor', motorCount: 4 },
        'skyhawk': { plates: 4, circuits: 1, extraCount: 1, motor: 'modern_industrialization:motor', motorCount: 2 }
    };
...
event.recipes.modern_industrialization.assembler(96, 600)
  ...
  .fluidIn("modern_industrialization:blood", 2000)
  .itemOut("1x createcybernetics:brainupgrades_berserk")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("1x createcybernetics:basecyberware_cybereyes")
  ...
  .itemOut("1x createcybernetics:eyeupgrades_multioptics1")
...
event.recipes.modern_industrialization.assembler(16, 200)
  ...
  .itemIn("2x modern_industrialization:aluminum_plate")
  .itemIn("4x modern_industrialization:electrum_fine_wire")
  .itemOut("1x createcybernetics:eyeupgrades_multioptics2")
...
event.recipes.modern_industrialization.assembler(16, 200)
  ...
  .itemIn("2x modern_industrialization:aluminum_plate")
  .itemIn("4x modern_industrialization:electrum_fine_wire")
  .itemOut("1x createcybernetics:eyeupgrades_multioptics3")
...
event.recipes.modern_industrialization.assembler(16, 200)
  ...
  .itemIn("2x modern_industrialization:aluminum_plate")
  .itemIn("4x modern_industrialization:electrum_fine_wire")
  .itemOut("1x createcybernetics:eyeupgrades_multioptics4")
...
event.recipes.modern_industrialization.assembler(96, 600)
  ...
  .itemIn("4x modern_industrialization:ruthenium_plate")
  ...
  .itemOut("1x createcybernetics:brainupgrades_kerenzikov")

event.recipes.modern_industrialization.assembler(96, 600)
  .itemIn("1x minecraft:heavy_core")
  .itemIn("8x modern_industrialization:osmiridium_curved_plate")
  .itemIn("4x modern_industrialization:processing_unit")
  .itemIn("4x modern_industrialization:rhodium_plated_palladium_plate")
  ...
  .fluidIn("modern_industrialization:soldering_alloy", 1000)
  .itemOut("1x createcybernetics:armupgrades_heavyknuckles")
...
event.recipes.modern_industrialization.assembler(16, 200)
  ...
  .itemIn("32x roll_mod:quantum_star")
  .itemIn("1x ae2:advanced_card")
  .itemIn("1x advanced_ae:quantum_upgrade_base")
  .itemOut("1x ae2wtlib:quantum_bridge_card")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("2x modern_industrialization:aluminum_curved_plate")
  .itemIn("8x modern_industrialization:cupronickel_wire_magnetic")
  .itemIn("2x #roll_mod:battaries_tier_three")
  .itemIn("1x modern_industrialization:stainless_steel_rod_magnetic")
  .itemOut("1x createcybernetics:emp_grenade")
...
event.recipes.modern_industrialization.assembler(16, 200)
  ...
  .itemIn("4x megacells:accumulation_processor")
  .itemOut("1x advanced_ae:quantum_crafter")
...
event.recipes.modern_industrialization.assembler(16, 200)
  ...
  .itemOut("1x merequester:requester")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("4x modern_industrialization:superconductor_wire")
  .itemIn("1x megacells:cell_component_1m")
  .itemIn("1x ae2:spatial_cell_component_128")
  .itemIn("3x modern_industrialization:processing_unit")
  .fluidIn("modern_industrialization:cryofluid", 500)
  .itemOut("1x megacells:bulk_cell_component")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("4x advanced_ae:quantum_storage_component")
  .itemIn("2x extendedae:concurrent_processor")
  .itemIn("2x megacells:accumulation_processor")
  .itemIn("1x advanced_ae:quantum_structure")
  .itemIn("2x modern_industrialization:enderium_gear")
  .itemOut("1x advanced_ae:quantum_storage_128")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("4x megacells:accumulation_processor")
  .itemIn("2x modern_industrialization:enderium_gear")
  .itemIn("1x advanced_ae:quantum_unit")
  .itemIn("2x advanced_ae:quantum_storage_128")
  .itemIn("4x extendedae:concurrent_processor")
  .itemOut("1x advanced_ae:quantum_storage_256")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("1x advanced_ae:quantum_unit")
  .itemIn("64x modern_industrialization:niobium_titanium_alloy_fine_wire")
  .itemIn("16x extendedae:concurrent_processor")
  .itemIn("16x megacells:accumulation_processor")
  .itemIn("1x advanced_ae:quantum_storage_256")
  .itemIn("16x advanced_ae:quantum_storage_component")
  .itemIn("16x modern_industrialization:processing_unit")
  .itemOut("1x advanced_ae:data_entangler")
...
event.recipes.modern_industrialization.assembler(16, 200)
  ...
  .itemOut("1x advanced_ae:quantum_accelerator")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("8x megacells:accumulation_processor")
  .itemIn("8x extendedae:concurrent_processor")
  .itemIn("2x modern_industrialization:enderium_gear")
  .itemIn("1x advanced_ae:quantum_unit")
  .itemIn("1x advanced_ae:quantum_accelerator")
  .itemIn("1x advanced_ae:quantum_storage_128")
  .itemIn("4x modern_industrialization:processing_unit")
  .itemOut("1x advanced_ae:quantum_core")
...
event.recipes.modern_industrialization.assembler(16, 200)
  ...
  .itemIn("16x extendedae:concurrent_processor")
  .itemIn("16x megacells:accumulation_processor")
  .itemOut("1x advanced_ae:quantum_multi_threader")
...
event.recipes.modern_industrialization.assembler(16, 200)
  ...
  .itemIn("8x modern_industrialization:advanced_motor")
  .itemIn("4x modern_industrialization:digital_circuit")
  .itemIn("1x modern_industrialization:centrifuge")
  .itemIn("12x modern_industrialization:enderium_plate")
  .itemIn("16x modern_industrialization:platinum_wire")
  .itemOut("1x mi_tweaks:maelstrom")
...
event.recipes.modern_industrialization.assembler(16, 200)
  ...
  .itemIn("1x modern_industrialization:titanium_tank")
  .itemIn("4x modern_industrialization:digital_circuit")
  .itemIn("1x modern_industrialization:electrolyzer")
  .itemIn("12x modern_industrialization:enderium_plate")
  .itemIn("16x modern_industrialization:platinum_wire")
  .itemOut("1x mi_tweaks:large_electrolyzer")
...
event.recipes.modern_industrialization.assembler(16, 200)
  ...
  .itemIn("3x roll_mod:solar_panel_1")
  .itemIn("1x modern_industrialization:basic_machine_hull")
  .itemIn("2x modern_industrialization:diode")
  .itemOut("1x roll_mod:solar_panel_2")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("4x modern_industrialization:electronic_circuit")
  .itemIn("4x roll_mod:solar_panel_2")
  .itemIn("1x modern_industrialization:basic_machine_hull")
  .itemOut("1x roll_mod:solar_panel_3")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("1x modern_industrialization:advanced_machine_hull")
  .itemIn("4x roll_mod:sunnarium_glass_mk2")
  .itemIn("4x roll_mod:solar_panel_3")
  .itemIn("2x modern_industrialization:aluminum_large_plate")
  .itemIn("4x modern_industrialization:electronic_circuit")
  .itemIn("4x modern_industrialization:pump")
  .itemOut("1x roll_mod:solar_panel_4")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("4x modern_industrialization:electronic_circuit")
  .itemIn("2x modern_industrialization:stainless_steel_large_plate")
  .itemIn("4x roll_mod:solar_panel_4")
  .itemIn("1x modern_industrialization:advanced_machine_hull")
  .fluidIn("modern_industrialization:polytetrafluoroethylene", 500)
  .itemOut("1x roll_mod:solar_panel_5")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("4x roll_mod:standard_chip_pmic")
  .itemIn("4x modern_industrialization:digital_circuit")
  .itemIn("4x roll_mod:solar_panel_5")
  .itemIn("1x modern_industrialization:advanced_machine_hull")
  .itemIn("2x modern_industrialization:stainless_steel_large_plate")
  .itemIn("4x modern_industrialization:large_pump")
  .fluidIn("modern_industrialization:polyvinyl_chloride", 500)
  .itemOut("1x roll_mod:solar_panel_6")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("4x modern_industrialization:digital_circuit")
  .itemIn("1x modern_industrialization:turbo_machine_hull")
  .itemIn("4x roll_mod:solar_panel_6")
  .itemIn("4x roll_mod:sunnarium_glass_mk3")
  .itemIn("6x roll_mod:standard_chip_nand")
  .fluidIn("modern_industrialization:helium", 500)
  .itemOut("1x roll_mod:solar_panel_7")
...
event.recipes.modern_industrialization.assembler(16, 200)
  ...
  .itemOut("1x ae2:crafting_unit")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("1x ae2:terminal")
  .itemIn("4x ae2:quartz_glass")
  .itemIn("4x ae2:fluix_smart_cable")
  .itemIn("4x modern_industrialization:aluminum_plate")
  .itemOut("1x ae2:chest")

event.recipes.modern_industrialization.assembler(8, 200)
  .itemIn("1x ae2:calculation_processor")
  .itemIn("1x ae2:cell_component_1k")
  .itemIn("4x modern_industrialization:gold_wire")
  .itemIn("2x modern_industrialization:aluminum_plate")
  .itemOut("1x ae2:memory_card")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("1x ae2:calculation_processor")
  .itemIn("4x ae2:fluix_block")
  .itemIn("8x modern_industrialization:aluminum_plate")
  .itemOut("1x ae2:energy_cell")

event.recipes.modern_industrialization.assembler(32, 400)
  .itemIn("4x ae2:spatial_pylon")
  ...
  .itemOut("1x ae2:spatial_io_port")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("1x ae2:wireless_booster")
  .itemIn("1x ae2:calculation_processor")
  .itemIn("4x modern_industrialization:stainless_steel_plate")
  .itemOut("1x ae2:wireless_receiver")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("1x ae2:wireless_receiver")
  .itemIn("4x ae2:fluix_smart_dense_cable")
  .itemIn("4x modern_industrialization:stainless_steel_ring")
  .itemOut("1x ae2:wireless_access_point")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("2x ae2:item_cell_housing")
  .itemIn("2x ae2:logic_processor")
  .itemIn("4x modern_industrialization:aluminum_plate")
  .itemIn("4x modern_industrialization:robot_arm")
  .itemIn("1x minecraft:crafting_table")
...
event.recipes.modern_industrialization.assembler(16, 200)
  ...
  .itemIn("1x ae2:cell_component_4k")
  .itemIn("4x ae2:fluix_smart_cable")
  .itemIn("4x modern_industrialization:aluminum_plate")
  .itemOut("1x ae2:io_port")

event.recipes.modern_industrialization.assembler(8, 200)
  .itemIn("2x modern_industrialization:lead_plate")
  .itemIn("2x modern_industrialization:gold_rod")
  .itemIn("1x minecraft:redstone_lamp")
  .itemOut("1x ae2netanalyser:network_analyser")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("1x ae2:import_bus")
  .itemIn("2x ae2:speed_card")
  .itemIn("2x roll_mod:advanced_robot_arm")
  .itemIn("4x modern_industrialization:aluminum_plate")
  .itemOut("1x extendedae:ex_import_bus_part")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("2x modern_industrialization:analog_circuit")
  .itemIn("4x modern_industrialization:iron_plate")
  .itemIn("1x ae2:fluix_block")
  .itemOut("1x ae2:charger")
...
event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("1x ae2:export_bus")
  .itemIn("2x ae2:speed_card")
  .itemIn("2x roll_mod:advanced_robot_arm")
  .itemIn("4x modern_industrialization:aluminum_plate")
  .itemOut("1x extendedae:ex_export_bus_part")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("1x ae2:network_tool")
  .itemIn("1x ae2:cell_component_1k")
  .itemIn("2x ae2:wireless_receiver")
  .itemIn("4x modern_industrialization:aluminum_plate")
  .itemOut("1x extendedae:wireless_tool")

event.recipes.modern_industrialization.assembler(8, 200)
  .fluidIn("modern_industrialization:polyethylene", 4000)
  .fluidIn("modern_industrialization:nylon", 2000)
  .itemIn("1x roll_mod:hazmat_leggings")
  .itemIn("7x roll_mod:carbon_mesh")
  .itemIn("4x modern_industrialization:electronic_circuit")
  .itemIn("1x roll_mod:energium_battery")
  .itemIn("4x modern_industrialization:large_motor")
  .itemIn("1x modern_industrialization:redstone_control_module")
  .itemOut("1x extended_industrialization:nano_leggings")

event.recipes.modern_industrialization.assembler(8, 200)
  .fluidIn("modern_industrialization:polyethylene", 4000)
  .fluidIn("modern_industrialization:nylon", 2000)
  .itemIn("1x roll_mod:hazmat_helmet")
  .itemIn("5x roll_mod:carbon_mesh")
  .itemIn("4x modern_industrialization:electronic_circuit")
  .itemIn("1x roll_mod:energium_battery")
  .itemIn("4x modern_industrialization:large_motor")
  .itemIn("4x #c:glass_panes")
  .itemIn("1x modern_industrialization:redstone_control_module")
  .itemOut("1x extended_industrialization:nano_helmet")
...
event.recipes.modern_industrialization.assembler(8, 200)
  ...
  .itemIn("4x modern_industrialization:large_motor")
  .itemIn("1x modern_industrialization:redstone_control_module")
  .itemOut("1x extended_industrialization:nano_boots")
...
event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("2x roll_mod:redstone_tube")
...
event.recipes.modern_industrialization.assembler(16, 200)
  ...
  .itemIn("2x minecraft:waxed_copper_bulb")
  .itemIn("1x minecraft:chiseled_bookshelf")
  .itemOut("1x toms_storage:storage_terminal")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("4x roll_mod:treated_plate")
  .itemIn("2x modern_industrialization:steel_gear")
  .itemIn("1x minecraft:crafter")
  .itemIn("1x toms_storage:storage_terminal")
  .itemOut("1x toms_storage:crafting_terminal")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("4x roll_mod:treated_plate")
  .itemIn("2x modern_industrialization:bronze_gear")
  .itemIn("2x minecraft:hopper")
  .itemIn("1x minecraft:chest")
  .itemOut("1x toms_storage:inventory_connector")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("2x roll_mod:treated_plate")
  .itemIn("3x minecraft:hopper")
  .itemIn("2x roll_mod:treated_log")
  .itemIn("1x modern_industrialization:bronze_gear")
  .itemOut("1x toms_storage:open_crate")
...
event.recipes.modern_industrialization.assembler(16, 200)
  ...
  .itemIn("2x modern_industrialization:bronze_gear")
  .itemIn("1x minecraft:chest")
  .itemOut("4x toms_storage:trim")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("4x roll_mod:treated_plate")
  .itemIn("2x modern_industrialization:bronze_gear")
  .itemIn("3x modern_industrialization:item_pipe")
  .itemOut("3x toms_storage:inventory_cable")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("4x roll_mod:treated_planks")
  .itemIn("3x minecraft:comparator")
  .itemIn("1x minecraft:hopper")
  .itemIn("1x minecraft:chest")
  .itemOut("1x toms_storage:inventory_interface")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("2x modern_industrialization:bronze_gear")
  .itemIn("1x toms_storage:inventory_cable")
  .itemIn("1x toms_storage:inventory_connector")
  .itemOut("1x toms_storage:inventory_cable_connector")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("6x roll_mod:treated_planks")
  .itemIn("2x minecraft:dropper")
  .itemIn("1x minecraft:repeater")
  .itemOut("1x toms_storage:inventory_proxy")
...
event.recipes.modern_industrialization.assembler(16, 200)
  ...
  .itemIn("1x modern_industrialization:capacitor")
  .itemOut("1x ad_astra:radio")

event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("4x modern_industrialization:large_motor")
  .itemIn("8x modern_industrialization:robot_arm")
  .itemIn("2x modern_industrialization:digital_circuit")
  .itemIn("1x #minecraft:hoes")
  .itemIn("1x modern_industrialization:advanced_machine_hull")
  .itemOut("1x roll_mod:crop_manager")
...
event.recipes.modern_industrialization.assembler(8, 300)
  .itemIn('4x modern_industrialization:polytetrafluoroethylene_rod')
  .itemIn('4x modern_industrialization:polytetrafluoroethylene_large_plate')
  .itemIn('1x modern_industrialization:polytetrafluoroethylene_gear')
  .itemOut('1x modern_industrialization:chemically_inert_ptfe_casing')
...
event.recipes.modern_industrialization.assembler(64, 600)
  ...
  .itemIn("8x modern_industrialization:electrum_fine_wire")
  .fluidIn("modern_industrialization:soldering_alloy", 250)
  .itemOut("1x createcybernetics:armupgrades_mantisblade_copper")
...
event.recipes.modern_industrialization.assembler(64, 600)
  ...
  .itemIn("8x modern_industrialization:electrum_fine_wire")
  .fluidIn("modern_industrialization:soldering_alloy", 250)
  .itemOut("1x createcybernetics:armupgrades_mantisblade_iron")
...
event.recipes.modern_industrialization.assembler(64, 600)
  ...
  .itemIn("8x modern_industrialization:electrum_fine_wire")
  .fluidIn("modern_industrialization:soldering_alloy", 250)
  .itemOut("1x createcybernetics:armupgrades_mantisblade_gold")

event.recipes.modern_industrialization.assembler(64, 600)
  .itemIn("4x modern_industrialization:titanium_plate")
  .itemIn("4x modern_industrialization:stainless_steel_gear")
  .itemIn("2x modern_industrialization:stainless_steel_rod")
  .itemIn("8x modern_industrialization:electrum_fine_wire")
  .fluidIn("modern_industrialization:soldering_alloy", 250)
...
event.recipes.modern_industrialization.assembler(64, 600)
  ...
  .itemIn("8x modern_industrialization:electrum_fine_wire")
  .fluidIn("modern_industrialization:soldering_alloy", 250)
  .itemOut("1x createcybernetics:armupgrades_mantisblade_diamond")
...
event.recipes.modern_industrialization.assembler(64, 600)
  ...
  .itemIn("8x modern_industrialization:electrum_fine_wire")
  .fluidIn("modern_industrialization:soldering_alloy", 250)
  .itemOut("1x createcybernetics:armupgrades_mantisblade_netherite")
...
event.recipes.modern_industrialization.assembler(16, 200)
  .itemIn("1x createcybernetics:basecyberware_rightleg")
  .itemIn("1x minecraft:gold_block")
...
event.recipes.modern_industrialization.assembler(32, 300)
  ...
  .itemIn("1x #roll_mod:battaries_tier_three")
  .itemIn("8x modern_industrialization:fluid_pipe")
...
event.recipes.modern_industrialization.assembler(16, 800)
  ...
  .itemIn("1x brewinandchewin:red_rum")
  .itemIn("1x sophisticatedbackpacks:feeding_upgrade")
  .itemIn("1x roll_mod:golden_xp_burger")
...
.itemIn("16x roll_mod:nylon_string")
.itemIn("4x modern_industrialization:magnalium_ring")
.itemOut("1x ad_astra:wheel")

event.recipes.modern_industrialization.assembler(128, 600)
.itemIn("2x modern_industrialization:digital_circuit")
.itemIn("1x modern_industrialization:hv_diesel_generator")
.itemIn("32x modern_industrialization:chrome_vanadium_steel_plate")
.itemIn("32x modern_industrialization:gold_plate")
.itemIn("16x modern_industrialization:rubber_sheet")
.itemIn("8x modern_industrialization:chrome_vanadium_steel_gear")
.itemIn("6x modern_industrialization:advanced_motor")
.itemIn("4x ad_astra:wheel")
.itemOut("1x ad_astra:tier_1_rover")

event.recipes.modern_industrialization.assembler(16, 100)
.itemIn("4x modern_industrialization:chrome_vanadium_steel_plate")
.itemIn("2x modern_industrialization:chrome_vanadium_steel_rod")
.itemIn("1x modern_industrialization:stainless_steel_tank")
...
event.recipes.modern_industrialization.assembler(8, 100)
.itemIn("10x roll_mod:standard_chip_pmic")
.itemIn("6x modern_industrialization:electronic_circuit")
.itemIn("4x modern_industrialization:stainless_steel_plate")
.itemIn("2x roll_mod:amethyst_oscillator")
.itemIn("1x roll_mod:energium_battery")
.itemOut("1x scannable_unofficial:scanner")

event.recipes.modern_industrialization.assembler(8, 100)
.itemIn("16x modern_industrialization:electrum_wire")
.itemIn("6x modern_industrialization:emerald_plate")
.itemIn("4x roll_mod:standard_chip_nand")
.itemIn("2x modern_industrialization:electronic_circuit")
.itemOut("1x scannable_unofficial:blank_module")

event.recipes.modern_industrialization.assembler(16, 100)
.itemIn("1x scannable_unofficial:blank_module")
.itemIn("16x minecraft:bone")
.itemIn("4x #roll_mod:battaries_tier_three")
.itemOut("1x scannable_unofficial:hostile_entity_module")

event.recipes.modern_industrialization.assembler(16, 800)
.itemIn("1x scannable_unofficial:blank_module")
.itemIn("8x roll_mod:raw_quartz")
.itemIn("8x roll_mod:raw_stibnite")
.itemIn("8x roll_mod:raw_sheldonite")
.itemIn("8x roll_mod:raw_lazurite")
.itemIn("8x roll_mod:raw_gold")
.itemIn("4x #roll_mod:battaries_tier_three")
.itemOut("1x scannable_unofficial:block_module")
})

...
event.recipes.modern_industrialization.circuit_assembler(4, 100)
  .itemIn("4x roll_mod:solar_panel_7")
  .itemIn("12x modern_industrialization:platinum_cable")
  .itemIn("4x modern_industrialization:digital_circuit")
  .itemIn("1x modern_industrialization:turbo_machine_hull")
  .itemIn("2x modern_industrialization:enderium_large_plate")
  .itemIn("8x roll_mod:carbon_mesh")
  .itemOut("1x roll_mod:solar_panel_8")

event.recipes.modern_industrialization.circuit_assembler(4, 100)
  .itemIn("2x modern_industrialization:titanium_large_plate")
  .itemIn("4x modern_industrialization:advanced_pump")
  .itemIn("4x modern_industrialization:processing_unit")
  .itemIn("2x modern_industrialization:titanium_64_large_plate")
  .itemIn("4x roll_mod:solar_panel_8")
  .itemIn("1x modern_industrialization:turbo_machine_hull")
  .fluidIn("modern_industrialization:moon_air", 500)
  .biome("ad_astra:orbit")
  .itemOut("1x roll_mod:solar_panel_9")

event.recipes.modern_industrialization.circuit_assembler(4, 100)
  .itemIn("1x modern_industrialization:incoloy_casing")
  .itemIn("4x modern_industrialization:uranium_235_ingot")
  .itemIn("4x modern_industrialization:processing_unit")
  .itemIn("4x roll_mod:solar_panel_9")
  .itemIn("1x modern_industrialization:highly_advanced_machine_hull")
  .itemIn("4x roll_mod:sunnarium_glass_mk4")
  .biome("ad_astra:orbit")
  .itemOut("1x roll_mod:solar_panel_10")

event.recipes.modern_industrialization.circuit_assembler(4, 100)
  .itemIn("4x roll_mod:solar_panel_10")
  .itemIn("8x roll_mod:nether_star_plate")
  .itemIn("4x roll_mod:engraved_crystal_chip")
  .itemIn("1x modern_industrialization:highly_advanced_machine_hull")
  .itemIn("12x modern_industrialization:superconductor_cable")
  .itemIn("4x modern_industrialization:osmiridium_large_plate")
  .biome("ad_astra:orbit")
  .itemOut("1x roll_mod:solar_panel_11")
...
.itemIn("6x roll_mod:blue_chip_ram")
.itemIn("4x modern_industrialization:memory_management_unit")
.itemIn("4x modern_industrialization:polytetrafluoroethylene_plate")
.itemIn("1x roll_mod:fr4_sheet")
.fluidIn("400x modern_industrialization:soldering_alloy")
.fluidIn("200x modern_industrialization:polytetrafluoroethylene")
.itemOut("1x modern_industrialization:random_access_memory")
...
.itemIn("2x roll_mod:superconducting_magnet")
.itemIn("2x modern_industrialization:niobium_titanium_alloy_rod")
.itemIn("1x roll_mod:quantum_star")
.itemOut("1x roll_mod:qubit_sensor")

event.recipes.modern_industrialization.circuit_assembler(64, 400)
.itemIn("12x roll_mod:superconducting_magnet")
.itemIn("6x modern_industrialization:superconductor_cable")
.itemIn("4x roll_mod:nether_star_plate")
.itemIn("4x modern_industrialization:osmiridium_plate")
.itemIn("4x modern_industrialization:tantalum_rhenium_plate")
.itemIn("1x modern_industrialization:quantum_circuit")
.itemOut("1x roll_mod:superconducting_module")


event.recipes.modern_industrialization.circuit_assembler(600, 100)
.itemIn("64x roll_mod:superconducting_magnet")
.itemIn("6x roll_mod:superconducting_module")
.itemIn("4x modern_industrialization:superconductor_coil")
.itemIn("2x modern_industrialization:quantum_circuit")
.itemIn("1x modern_industrialization:plasma_handling_iridium_machine_casing")
.itemIn("1x modern_industrialization:large_heat_exchanger")
.itemOut("1x modern_industrialization:fusion_chamber")

event.recipes.modern_industrialization.circuit_assembler(60, 600)
.itemIn("6x modern_industrialization:osmiridium_large_plate")
.itemIn("6x modern_industrialization:netherite_large_plate")
.itemIn("6x modern_industrialization:tantalum_rhenium_large_plate")
.itemIn("4x roll_mod:superconducting_magnet")
.itemIn("1x modern_industrialization:large_heat_exchanger")
.itemIn("1x modern_industrialization:large_heat_exchanger")
.itemOut("1x modern_industrialization:plasma_handling_iridium_machine_casing")

event.recipes.modern_industrialization.circuit_assembler(32, 600)
.itemIn("32x modern_industrialization:platinum_fine_wire")
.itemIn("8x modern_industrialization:arithmetic_logic_unit")
.itemIn("4x modern_industrialization:digital_circuit")
.itemIn("4x modern_industrialization:random_access_memory")
.itemIn("3x modern_industrialization:memory_management_unit")
.itemIn("1x modern_industrialization:processing_unit_board")
.itemOut("1x modern_industrialization:processing_unit")
...
.itemIn("1x roll_mod:engraved_crystal_chip")
.fluidIn("200x modern_industrialization:polytetrafluoroethylene")
...
.fluidIn("200x modern_industrialization:polytetrafluoroethylene")
.itemOut("1x modern_industrialization:arithmetic_logic_unit")

event.recipes.modern_industrialization.circuit_assembler(64, 800)
.itemIn("16x modern_industrialization:transistor")
.itemIn("16x modern_industrialization:not_gate")
.itemIn("8x modern_industrialization:and_gate")
.itemIn("8x modern_industrialization:or_gate")
.itemIn("8x modern_industrialization:capacitor")
